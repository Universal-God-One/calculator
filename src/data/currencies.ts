...
export const ALL_CURRENCIES: Record<string, CurrencyInfo> = {
  ...
  'ALL': { symbol: 'L', name: 'Albanian Lek', code: 'ALL' },
  'DZD': { symbol: 'دج', name: 'Algerian Dinar', code: 'DZD' },
  ...
  'BTN': { symbol: 'Nu', name: 'Bhutanese Ngultrum', code: 'BTN' },
  ...
  'BND': { symbol: 'B$', name: 'Brunei Dollar', code: 'BND' },
  'BGN': { symbol: 'лв', name: 'Bulgarian Lev', code: 'BGN' },
  'BIF': { symbol: 'Fr', name: 'Burundian Franc', code: 'BIF' },
  'KHR': { symbol: '៛', name: 'Cambodian Riel', code: 'KHR' },
  'XAF': { symbol: 'FCFA', name: 'Central African CFA Franc', code: 'XAF' },
  'CAD': { symbol: 'CA$', name: 'Canadian Dollar', code: 'CAD' },
  'CVE': { symbol: '$', name: 'Cape Verdean Escudo', code: 'CVE' },
  'KYD': { symbol: 'CI$', name: 'Cayman Islands Dollar', code: 'KYD' },
  'CLP': { symbol: 'CLP$', name: 'Chilean Peso', code: 'CLP' },
  'CNY': { symbol: '¥', name: 'Chinese Yuan', code: 'CNY' },
  'COP': { symbol: 'COP$', name: 'Colombian Peso', code: 'COP' },
  'KMF': { symbol: 'CF', name: 'Comorian Franc', code: 'KMF' },
  'CDF': { symbol: 'FC', name: 'Congolese Franc', code: 'CDF' },
  ...
  'GTQ': { symbol: 'Q', name: 'Guatemalan Quetzal', code: 'GTQ' },
  'GNF': { symbol: 'FG', name: 'Guinean Franc', code: 'GNF' },
  'GYD': { symbol: 'GY$', name: 'Guyanese Dollar', code: 'GYD' },
  'HTG': { symbol: 'G', name: 'Haitian Gourde', code: 'HTG' },
  'HNL': { symbol: 'L', name: 'Honduran Lempira', code: 'HNL' },
  ...
  'KGS': { symbol: 'лв', name: 'Kyrgystani Som', code: 'KGS' },
  'LAK': { symbol: '₭', name: 'Laotian Kip', code: 'LAK' },
  ...
  'MOP': { symbol: 'P', name: 'Macanese Pataca', code: 'MOP' },
  'MKD': { symbol: 'ден', name: 'Macedonian Denar', code: 'MKD' },
  'MGA': { symbol: 'Ar', name: 'Malagasy Ariary', code: 'MGA' },
  ...
  'MRU': { symbol: 'UM', name: 'Mauritanian Ouguiya', code: 'MRU' },
  ...
  'OMR': { symbol: '﷼', name: 'Omani Rial', code: 'OMR' },
  ...
  'RWF': { symbol: 'Fr', name: 'Rwandan Franc', code: 'RWF' },
  ...
  'SOS': { symbol: 'Sh', name: 'Somali Shilling', code: 'SOS' },
  ...
  'LKR': { symbol: '₨', name: 'Sri Lankan Rupee', code: 'LKR' },
  'SDG': { symbol: '£', name: 'Sudanese Pound', code: 'SDG' },
  'SRD': { symbol: '$', name: 'Surinamese Dollar', code: 'SRD' },
  ...
  'TJS': { symbol: 'SM', name: 'Tajikistani Somoni', code: 'TJS' },
  'TZS': { symbol: 'Sh', name: 'Tanzanian Shilling', code: 'TZS' },
  'THB': { symbol: '฿', name: 'Thai Baht', code: 'THB' },
  'TOP': { symbol: 'T$', name: 'Tongan Paʻanga', code: 'TOP' },
  'TTD': { symbol: 'TT$', name: 'Trinidad & Tobago Dollar', code: 'TTD' },
  ...
  'UGX': { symbol: 'Sh', name: 'Ugandan Shilling', code: 'UGX' },
  ...
  'VES': { symbol: 'Bs.S', name: 'Venezuelan Bolívar', code: 'VES' },
  'VND': { symbol: '₫', name: 'Vietnamese Dong', code: 'VND' },
  'YER': { symbol: '﷼', name: 'Yemeni Rial', code: 'YER' },
  'ZMW': { symbol: 'ZK', name: 'Zambian Kwacha', code: 'ZMW' },
  'ZWL': { symbol: 'Z$', name: 'Zimbabwean Dollar', code: 'ZWL' },
}

// Sorted alphabetically by country name for dropdown
export const CURRENCY_LIST = Object.values(ALL_CURRENCIES).sort((a, b) =>
  a.name.localeCompare(b.name)
)

export const getSymbol = (code: string): string =>
  ALL_CURRENCIES[code]?.symbol ?? code

export const fmtMoney = (n: number, currencyCode: string): string => {
